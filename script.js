...
function drop_handler(ev) {
    ...
    // Show password input elements and "Encrypt File" button
    document.getElementById('txtEncpassphrase').removeAttribute('hidden');
    document.getElementById('txtEncpassphraseretype').removeAttribute('hidden');
    document.getElementById('btnEncrypt').removeAttribute('hidden');
  
    // Toggle visibility of minCharMsg element based on the number of files dropped
    ...
    // Get a reference to the encryption card element
    const encCard = document.getElementById("divEncryptfile");
  
    // Set the display property of the card to "block"
    encCard.style.display = "block";
...
var spndecfilename = document.getElementById("spndecfilename");
if (spndecfilename) {
